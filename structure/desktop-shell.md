...
Package update and service repair also preserve that grant instead of reviving the package
service when the approved subject is unchanged. The write path is stricter than the relaunch
